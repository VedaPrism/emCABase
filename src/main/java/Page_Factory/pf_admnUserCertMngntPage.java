...
public class pf_admnUserCertMngntPage extends pf_genericmethods {
	...
	@FindBy(how = How.XPATH, using = "//ul[@id='accordion']/li[3]/a") WebElement userCertMngmnt;
	@FindBy(how = How.XPATH, using = "//*[@id='userCertSearchMenu']/a") WebElement userSearch;
	...
	public pf_admnUserCertMngntPage(WebDriver driver){

		PageFactory.initElements(driver, this);

	}

	public void usercertDetailsSearch() throws Exception {
		cl_click(homeBtn);
		Thread.sleep(2000);
