...
public class Utility{
	...
	public static ListIterator<Object[]> dp_commonlogic(String sheetname, String scriptname) throws Exception{
		...
		ExcelRw er = new ExcelRw(System.getProperty("user.dir")+"\\src\\main\\resources\\emCA.xlsx");
		...
		for(int i=1;i<=rc;i++){
			...
			if(script.equalsIgnoreCase(scriptname)) {
				if(actual.equalsIgnoreCase(expted)) {
					...
					er.saveclose(System.getProperty("user.dir")+"\\src\\main\\resources\\emCA.xlsx");
					//break;
				}
			}
	...
	public static String getpropertydetails(String Key) throws Exception{
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\resources\\emCA-Config.properties");
