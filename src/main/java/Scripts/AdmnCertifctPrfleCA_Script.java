...
public class AdmnCertifctPrfleCA_Script  extends Basefunctions {
	final static Logger log = Logger.getLogger(AdmnCertifctPrfleCA_Script.class);
	...
	public void certificateProfileCA(Map hm) throws Exception{	
		...
		pf_admnPfleMngntCertPrflePage c=new pf_admnPfleMngntCertPrflePage(w);
		if(scriptName.equalsIgnoreCase("certPrfleCARoot")) {
			et =  es.startTest("CA profile under Root");
